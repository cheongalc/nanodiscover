...
export RAY_NUM_CPUS=24  # this controls the number of CPUs Ray can use, if you don't set it, Ray will use all available CPUs
export NANODISCOVER_EVALUATOR_NUM_WORKERS=24  # local CPU eval workers; additional workers come from Slurm array jobs when using slurm_attached
