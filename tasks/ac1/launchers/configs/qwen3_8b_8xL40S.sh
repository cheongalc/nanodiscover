...
export NANODISCOVER_GENERATOR_DATA_PARALLEL_SIZE=8
...
export NANODISCOVER_TRAINER_NUM_WORKERS=8  # DeepSpeed processes (one per GPU)
...
export NANODISCOVER_SEQUENCE_PARALLEL_SIZE=8  # Ulysses sequence parallelism degree; for now, this should equal TRAINER_NUM_WORKERS because we don't support tensor parallelism yet
