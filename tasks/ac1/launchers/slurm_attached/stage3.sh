...
cd "$(dirname "$0")/../../../.."
# Ensure evaluate-shard and multiprocessing children resolve core/tasks from this tree (not site-packages).
...
source tasks/ac1/launchers/slurm_attached/profile_env.sh
...
submit_remote_wave_from_indices() {
  ...
  if ! job_id=$(sbatch --parsable \
    ...
    tasks/ac1/launchers/slurm_attached/stage3_array.sbatch.sh \
