...
bash tasks/circle_packing/launchers/slurm_alloc/staged/run_all.sh
...
bash tasks/circle_packing/launchers/slurm_alloc/staged/run_one_epoch.sh
```
...
| `SLURM_ALLOC_STAGED_EVAL_CPUS_PER_TASK` | CPUs per eval task (1 for circle packing) |
