...
from tasks.ac2.prompt import build_ac2_state_context, default_initial_code, format_fenced_python, render_ac2_prompt
from tasks.ac2.evaluator import AC2_CPUS_PER_EVAL, evaluate_candidate_code, evaluate_sequence


AC2_INITIAL_STATE_CREATION_SEED = 12345
AC2_BUDGET_SECONDS = 1000
AC2_EVAL_TIMEOUT_SECONDS = 1100
...
class AC2Task:
    ...
    def evaluation_resources(self) -> TaskEvaluationRequirements:
        return TaskEvaluationRequirements(cpus_per_eval=AC2_CPUS_PER_EVAL)

    def make_initial_state(self) -> ArchiveNode:
        rng = np.random.default_rng(AC2_INITIAL_STATE_CREATION_SEED)
